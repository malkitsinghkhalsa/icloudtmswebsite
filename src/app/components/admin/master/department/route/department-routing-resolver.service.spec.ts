...
describe('Department routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IComorbidity returned by find', () => {
      // GIVEN
      service.find = jest.fn(id => of(new HttpResponse({ body: { id } })));
      mockActivatedRouteSnapshot.params = { id: 0 };
      ...
      // THEN
      expect(service.find).toBeCalledWith('0');
      expect(resultDepartment).toEqual({ id: 'ABC' });
    });

    it('should return new IComorbidity if id is not provided', () => {
      // GIVEN
